"""Frontend ROS node and backend-compatible proxy for the Qt application."""
...
from .task_commands import TaskCommand
...
class ControlUiFrontendNode(Node):
    """Qt-facing ROS node that talks only to the backend transport topics."""
